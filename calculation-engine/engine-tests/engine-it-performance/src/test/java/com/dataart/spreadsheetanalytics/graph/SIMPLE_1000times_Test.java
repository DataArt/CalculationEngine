...
public class SIMPLE_1000times_Test extends ZParentTest {

    @State(Scope.Benchmark)
    public static class BenchmarkStateEvaluator {
        int iterations = 1000;
        String excelFile = "src/test/resources/datamodel/graph/SIMPLE_" + iterations + "times.xlsx";
        Object expectedValue = new Double(2.0);
