...
public class DSLOOKUP_1000set_10times_not_found_Test extends ZParentTest {
    ...
    public static class BenchmarkStateEvaluator {
        ...
        String excelFile = "src/test/resources/datamodel/dslookup/shuffled/DSLOOKUP_" + dataSetSize + "set_" + dslookups + "times_not_found.xlsx";
