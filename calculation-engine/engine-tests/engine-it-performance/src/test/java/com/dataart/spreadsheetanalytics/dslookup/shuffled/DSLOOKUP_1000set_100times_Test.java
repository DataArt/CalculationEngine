...
public class DSLOOKUP_1000set_100times_Test extends ZParentTest {
    ...
    public static class BenchmarkStateEvaluator {
        ...
        String excelFile = "src/test/resources/datamodel/dslookup/shuffled/DSLOOKUP_" + dataSetSize + "set_" + iterations + "times.xlsx";
