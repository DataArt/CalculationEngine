 ...
 * Two methods: {@link #evaluate(IA1Address)} and {@link #evaluate()} are designed to do it.
 * 
...
public interface IEvaluator {
     ...
     */
    IEvaluationResult<ICellValue> evaluate(IA1Address addr);

    /**
     * Does evaluation for every not-empty cell in {@link IDataModel}.
     * Simple realisation is done {@link #evaluate(IA1Address)} for every cell in for loop.
