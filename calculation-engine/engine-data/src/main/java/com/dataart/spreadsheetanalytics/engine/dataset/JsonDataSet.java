...
public class JsonDataSet extends AbstractLazyDataSet {

    private static final RuntimeException NS = new UnsupportedOperationException("Class " + JsonDataSet.class.getSimpleName() + " is a stub and not yet implemented.");

    public JsonDataSet(String name) {
        super(name);
    }
